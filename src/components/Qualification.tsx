      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 relative">
              {(qualifications.education as Education[]).map((edu, index) => (
                <div
                  key={edu.id}
                  className="relative pl-12 pb-8 timeline-item animate-fade-in-left"
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 relative">
              {(qualifications.experience as Experience[]).map((exp, index) => (
                <div
                  key={exp.id}
                  className="relative pl-12 pb-8 timeline-item animate-fade-in-right"
                  style={{ animationDelay: `${index * 0.2}s` }}
                >
                  <div className="timeline-dot"></div>
                  <div className="card hover:border-primary">
