                  ...
                  {selectedProject.images.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-3 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-70 transition-all duration-200"
                      >
                        <ArrowLeft size={20} />
                      </button>
                      <button
                        onClick={nextImage}
                        className="absolute right-3 top-1/2 -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-70 transition-all duration-200"
                      >
                        <ArrowRight size={20} />
                      </button>
                        ...
                        <>
                          ...
                          <p className="text-sm text-gray-300 mt-2 flex items-center gap-2">
                            ...
                            <style>{`
                              ...
                              .icon-pulse svg { transform-origin: center; }
                              @keyframes iconPulse {
